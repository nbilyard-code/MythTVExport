...
# The orginal files were recoreded with a InfiniTV PCI using a cablecard to decode.
# The original files are a mix of mpg and ts files.
#
...
#
# To use this script, you can call it directly.  It takes no arguments from the command line.
